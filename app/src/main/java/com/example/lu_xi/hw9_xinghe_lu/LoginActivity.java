...
public class LoginActivity extends FirebaseLoginBaseActivity{
    ...
    /* String Constants */
    private static final String FIREBASEREF = "https://crackling-fire-8001.firebaseio.com/";
...
// Initialize the SDK before executing any other operations, especially, if you're using Facebook UI elements.
    ...
    protected void onFirebaseLoginUserError(FirebaseLoginError firebaseLoginError) {
        ...
        snackbar.show();
        Log.d("Errorrr","this really happened...");
        resetFirebaseLoginPrompt();
    }
    ...
    public void onFirebaseLoggedIn(AuthData authData) {
        ...
        Intent myIntent = new Intent(LoginActivity.this, TaskOneActivity.class);
